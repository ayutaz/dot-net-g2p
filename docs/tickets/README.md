...
|--------------|----------|------|---------|----------|
| [Sw1](#sw1-コアルールエンジン--基本mvp) | 7 | 0/7 | < 15% | 150+ |
| [Sw2](#sw2-例外辞書--テキスト正規化--x-sampa) | 5 | 0/5 | < 8% | 250+ |
| [Sw3](#sw3-ピッチアクセント--方言--pua--prosody) | 5 | 0/5 | < 4% | 350+ |
| [Sw4](#sw4-multilingual統合--評価ツール--リリース) | 5 | 0/5 | < 4% | 400+ |
| **合計** | **22** | **0/22** | | |
...
目標: `SwedishG2PEngine.ToIPA("hej")` → `"hɛj"` が動作する最小G2Pエンジン
