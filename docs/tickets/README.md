...
| ID | タイトル | 状態 | 依存 | 後続 |
|----|----------|------|------|------|
| [T01](T01-misaki-mapping-tables.md) | PinyinToMisaki マッピングテーブル設計・実装 | 完了 | なし | T02 |
| [T02](T02-misaki-convert-method.md) | PinyinToMisaki Convert メソッド統合 | 完了 | T01 | T03 |

### Phase 2 — Mi2: API統合 + テスト

| ID | タイトル | 状態 | 依存 | 後続 |
|----|----------|------|------|------|
| [T03](T03-engine-api-integration.md) | ChineseG2PEngine ToMisakiIPA API 追加 | 完了 | T02 | T04 |
| [T04](T04-misaki-tests.md) | Misaki互換テスト実装 | 完了 | T03 | T05 |

### Phase 3 — Mi3: ドキュメント・品質保証・リリース準備

| ID | タイトル | 状態 | 依存 | 後続 |
|----|----------|------|------|------|
| [T05](T05-documentation-qa.md) | ドキュメント更新・品質保証 | 完了 | T04 | T06 |
| [T06](T06-release-followup.md) | Issue#56 フォローアップ・リリース準備 | 完了 | T05 | なし |
