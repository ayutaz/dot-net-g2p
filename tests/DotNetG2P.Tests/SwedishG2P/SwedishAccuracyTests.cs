...
namespace DotNetG2P.Tests.SwedishG2P
{
    ...
    public class SwedishAccuracyTests : IDisposable
    {
        ...
        // =====================================================================
        // 基本語彙（12テスト）
        // IPA期待値はSvensk uttalsordbok (Elert 2000) および
        // svenska.se (Institutet för språk och folkminnen) に基づく。
        // =====================================================================
        ...
        // =====================================================================
        // 長短母音ミニマルペア（6テスト）
        // 母音長はスウェーデン語音韻規則（単子音末尾＝長母音、重子音/
        // 子音連結＝短母音）による。音価はElert 2000に準拠。
        // =====================================================================
        ...
        // =====================================================================
        // sj音パターン（8テスト）
        // sj/skj/stj/sch → /ɧ/、sk+軟母音(e,i,y,ä,ö) → /ɧ/ の規則。
        // Riad (2014) "The Phonology of Swedish" および svenska.se に基づく。
        // =====================================================================
        ...
        // =====================================================================
        // tj音パターン（5テスト）
        // tj → /ɕ/、k+軟母音(e,i,y,ä,ö) → /ɕ/ の規則。
        // Riad (2014) および svenska.se に基づく。
        // =====================================================================
        ...
        // =====================================================================
        // そり舌音パターン（5テスト）
        // rd→/ɖ/, rn→/ɳ/, rs→/ʂ/, rl→/ɭ/ のそり舌同化規則。
        // 中央スウェーデン語標準方言の特徴。Riad (2014) に基づく。
        // =====================================================================
        ...
        // =====================================================================
        // 黙字パターン（5テスト）
        // dj/lj/hj → /j/、gn → /n/、ps → /s/ の語頭黙字規則。
        // Elert (2000) および svenska.se に基づく。
        // =====================================================================
        ...
        // =====================================================================
        // 重子音（ジェミネート）縮約（3テスト）
        // 正書法の重子音（tt, ss等）は先行母音を短母音化し、
        // 子音自体は単一音素に縮約される。Elert (2000) に基づく。
        // =====================================================================
        ...
        // =====================================================================
        // -tion/-sion語（2テスト）
        // -tion/-sion は /ɧuːn/ と発音される（スウェーデン語固有の借用語規則）。
        // Elert (2000) および svenska.se に基づく。
        // =====================================================================
        ...
        // =====================================================================
        // 追加語彙（7テスト）
        // 各種音韻規則の追加検証。IPA期待値は svenska.se および
        // Elert (2000) に基づく。
        // =====================================================================
