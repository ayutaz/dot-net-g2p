...
{
    /// <summary>
    /// IPA 音素配列と韻律情報を組み合わせたフランス語韻律変換結果。
    /// </summary>
    public sealed class FrenchProsodyResult
    {
        /// <summary>IPA 音素配列。</summary>
        public string[] Phonemes { get; }

        /// <summary>各音素に対応する韻律情報。Phonemes と同じ長さ。</summary>
        public FrenchProsodyInfo[] Prosody { get; }
        ...
        public FrenchProsodyResult(string[] phonemes, FrenchProsodyInfo[] prosody)
        {
