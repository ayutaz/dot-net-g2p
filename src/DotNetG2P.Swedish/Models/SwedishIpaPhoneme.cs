namespace DotNetG2P.Swedish
{
    ...
    {
        // === 長母音 (0-8) === ※ SwedishPhoneme.IsLongVowel は <= LongA(8) で判定
        ...
        // === 短母音 (9-17) === ※ SwedishPhoneme.IsVowel は <= Schwa(17) で判定
        ...
        // === 破裂音 (18-23) === ※ SwedishPhoneme.IsConsonant は >= P(18) で判定
        /// <summary>/p/</summary>
        P = 18,
        /// <summary>/b/</summary>
        B = 19,
        ...
        // === そり舌音 (36-40) === ※ SwedishPhoneme.IsRetroflex は RetroT(36)..RetroS(40) で判定
        ...
        // === 破擦音 (41) ===
        /// <summary>/t͡ɕ/ 無声歯茎硬口蓋破擦音（FinlandSwedish方言のtj音）</summary>
        TjAffricate = 41,
    }
}
